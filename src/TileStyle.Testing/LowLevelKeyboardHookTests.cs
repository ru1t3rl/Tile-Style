...
{
    private ILogger<LowLevelKeyboardHook> _logger = null!;
    ...
    public void Setup()
    {
        _logger = Substitute.For<ILogger<LowLevelKeyboardHook>>();
        _hiddenWindow = new HiddenWindow();
        _hook = new LowLevelKeyboardHook(_logger, _hiddenWindow);
    }
